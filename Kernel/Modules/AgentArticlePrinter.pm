package Kernel::Modules::AgentArticlePrinter;
...
sub Run {
    ...
    $Param{PrintedBy}= "$PrintedBy $Self->{UserFirstname}$Self->{UserLastname} ($Self->{UserEmail}), $Time";
    ...
    $Output .= $LayoutObject->Output(
    	TemplateFile => 'AgentArticlePrinter',
    	Data         => \%Param,
    	);
