...
package Kernel::Modules::ProblemEscalation;
...
sub Run {
    my ( $Self, %Param ) = @_;
	#my @ViewableTicketsTypeIDS =(2);
	
#Jugni added below code for get the Problem ID from Type DB
    ...
    {
		#############################Filter for Problem Viewable Tickets ###########################################3 
