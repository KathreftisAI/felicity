...
package Kernel::GenericInterface::Operation::Ticket::GetLinkedFAQData;
...
sub Run {
    ...
    return $Self->ReturnError(
        ErrorCode    => 'GetLinkedFAQData.AuthFail',
        ErrorMessage => "GetLinkedFAQData: Authorization failing!",
    ) if !$UserID;
