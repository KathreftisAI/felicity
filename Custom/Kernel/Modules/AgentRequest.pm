...
package Kernel::Modules::AgentRequest;
...
sub Run {
    ...
    my %Filters = (
        ...
        #added for show close ticket on Request overview page by ashish
        Close => {
...
#################End of code#################################################        
        ...
        $QueueStrg
            .= "<li><a href=\"$LayoutObject->{Baselink}Action=AgentRequest;QueueID=$Queue{QueueID}";
