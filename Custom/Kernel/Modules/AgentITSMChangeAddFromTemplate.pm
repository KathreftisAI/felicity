...
sub Run {
    ...
    my %GetParam;
    for my $ParamName (
        qw(MoveTimeType MoveTimeYear MoveTimeMonth MoveTimeDay MoveTimeHour MoveTimeMinute TicketID TemplateID ITSMChangeGroupID)
        )
    {
...
#################################################################################
######################Code added to add ITSM Change Group ID By Milan#########
#################################################################################                
            else{    
...
#################################################################################
######################End of code to add ITSM Change Group ID By Milan###########
#################################################################################
    ...
    $ITSMChangeGroups{''}='';
    my $ITSMChangeGroupIDSelectionString = $LayoutObject->BuildSelection(
        Data       => \%ITSMChangeGroups,
        Name       => 'ITSMChangeGroupID',
        Class      => 'Modernize Validate_Required ' . ( $Param{Errors}->{'ITSMChangeGroupID'} || '' ),
    );
    ...
    $Output .= $LayoutObject->Output(
        ...
        Data         => {
            ...
            ITSMChangeGroupIDSelectionString => $ITSMChangeGroupIDSelectionString,
        },
    );
