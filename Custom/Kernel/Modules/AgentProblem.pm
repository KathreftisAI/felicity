...
package Kernel::Modules::AgentProblem;
...
sub Run {
    ...
    my %Filters = (
        ...
        #added for show close ticket on Problem overview page by ashish
        Close => {
...
#################End of code#################################################        
        ...
        $QueueStrg
            .= "<li><a href=\"$LayoutObject->{Baselink}Action=AgentProblem;QueueID=$Queue{QueueID}";
